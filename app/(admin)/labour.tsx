...
import { Download, ChevronDown, Check, X, Building2, Truck, HardHat, Calendar, Clock, AlertCircle, Image as ImageIcon, Info } from 'lucide-react-native';
            ...
            {selectedEntry && (
              <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }} style={{ minHeight: 0 }}>
                ...
                {!!selectedEntry.no_photo_reason && (
                  <View className="mb-4 bg-blue-50 p-4 rounded-2xl border border-blue-100 flex-row items-start">
